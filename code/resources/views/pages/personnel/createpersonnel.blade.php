@extends('layouts.dashboard', ['title' => "RHConnect / New Personnel"])
@section('content')
...
<div class="container-fluid p-0">
    ...
    <form method="POST" action="{{ route('pages.personnel.createpersonnel') }}" enctype ="multipart/form-data" autocomplete="off">
        @csrf
        ...
        <section class="breadcrumb-canvas d-flex justify-content-between align-items-center mb-4">
            <div class="title-section d-flex align-items-center">
                <h2 class="mb-0 text-gray-600"> <a class="link link-gray-100" href="{{ route('pages.personnel.viewpersonnellist') }}">Personnel</a> / <span class="fw-semi text-black-25">Create New Personnel</span></h2>
            </div>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="__content-heading m-0 font-weight-bold" style="font-size: 20px">Add New Personnel</h6>
            </div>
            <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="fname" placeholder="Enter Here" required>
                        </div>
                        <div class="col-md-4">
                            <label class="pt-2">
                                Last Name
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control mb-1" name="roles">
