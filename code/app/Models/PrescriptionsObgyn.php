...
class PrescriptionsObgyn extends Model  implements CipherSweetEncrypted
{
    use HasFactory;
    ...
    protected $table = 'prescription_obgyn';
    protected $fillable = [
        'patient_ob_id',
        'patient_medname',
        'patient_meddose',
    ...
    public function prescription_to_obgyn() {
        return $this->belongsTo(Obgyns::class, 'patient_ob_id', 'patient_ob_id');
    }
